 ...
 */
public class StampyHash extends AModule {

    public StampyHash(Communicator c) {
        super(c);
    }
    ...
    public void setParameters() {
        ...
        this.parameters = new String[]{"stampy", "-g", this.communicator.getGUI_reference(), "-H", this.communicator.getGUI_reference()};
